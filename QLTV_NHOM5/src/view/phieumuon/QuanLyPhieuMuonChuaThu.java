...
import Util.CustomTablePhieuMuonChuaThu;
 ...
 * @author WIN1064
 */
public class QuanLyPhieuMuonChuaThu extends javax.swing.JPanel {
    ...
    public static QuanLyPhieuMuonChuaThu qlpm;
    boolean daLoc = false;
    /**
     * Creates new form QuanLyPhieuMuon
     */
    public QuanLyPhieuMuonChuaThu() {
        initComponents();
        LuuDuLieu.dsPMCTCT = pmc.getPMCTCT();
        // get danh sách phiếu mượn chi tiết chưa thu gán vào LuuDuLieu.dsPMCT;
        loadTable();
        qlpm = this;
    ...
    public void loadTable() {
        jTableMuonSach.setModel(new CustomTablePhieuMuonChuaThu());
        CustomTablePhieuMuonChuaThu ct = new CustomTablePhieuMuonChuaThu();
        // lấy số cột để căn giữa
        renderer.setHorizontalAlignment(JLabel.CENTER);
        // dùng để căn giữa cho từng cột
    ...
    public void thongKe() {
        tongPhieu = Integer.toString(LuuDuLieu.dsPMCTCT.size());
        jLabelTongPhieu.setText("Tổng số phiếu : " + tongPhieu);
        tienGiu = Integer.toString(LuuDuLieu.dsPMCTCT.stream().mapToInt(s -> s.getTienCoc()).sum());
    ...
    private void jTableMuonSachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMuonSachMouseClicked
        ...
        LuuDuLieu.currentPhieuMuonChiTiet = LuuDuLieu.dsPMCTCT.get(selectedRow);
        ...
        if (selectedRow < 0) {
            ...
            if (op == 0) {
                if (pmc.updateDaTra(LuuDuLieu.currentPhieuMuonChiTiet.getMaPhieu()) == 1) {
                    LuuDuLieu.dsPMCTCT = pmc.getPMCTCT();
                    loadTable();
                    LuuDuLieu.dsPMCTDT = pmc.getPMCTDT();
                    QuanLyPhieuMuonDaThu.qlpt.loadTable();
                    selectedRow = -1;
                }
            }
        }
    ...
    private void jButtonTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTimKiemActionPerformed
        ...
        if (jDateChooserTu.getDate() != null && jDateChooserDen.getDate() != null && daLoc == true) {
            ...
            LuuDuLieu.dsPMCTCT = pmc.locPhieu(tuNgay, denNgay, keywords);
        } else {
            if (keywords.trim().equals("")) {
                JOptionPane.showMessageDialog(null, "Vòng lòng nhập từ khóa");
            } else {
                LuuDuLieu.dsPMCTCT = pmc.locPhieu(null, null, keywords);
            }
        }
        loadTable();
